  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          'bg-muted relative z-0 isolate rounded-l-(--cell-radius) after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-muted',
          defaultClassNames.range_start,
        ),
        range_middle: cn('rounded-none', defaultClassNames.range_middle),
        range_end: cn(
          'bg-muted relative z-0 isolate rounded-r-(--cell-radius) after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-muted',
